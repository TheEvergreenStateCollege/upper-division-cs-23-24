...
if __name__ == "__main__":
    ...
    # List of model paths  ## Don't forget to change the model path names
    model_paths = ["model_20240602_185616.pth", "model_20240602_052728.pth", "model_20240602_091244.pth"]
