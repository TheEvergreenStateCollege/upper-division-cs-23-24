...
Acer_macrophyllum={ 
    ...
    bundleScars:["7"],
    leafScarShape:["V-shaped"],
    leafScarTouching:["yes"],
    lenticelColor:["pale"],
    lenticelVisibility:["prominent"],
    catkins:["no"],
    ...
    Buds:["Buds increasing in size toward the apex, from minute at base of twig to large above; terminal bud present, 1/2 inch, more or less, long, apical internode suppressed, causing terminal bud to appear multiple; lateral buds appressed, 3 sided, slightly stalked; exposed scales about 4, green or red-brown with pale ciliate margins, and tipped with a tuft of longer hairs or frequently with leaf blade rudiments; buds in axils of the outer scales; inner scales densely pubescent; leaf rudiments conduplicate."],
...
Malus_fusca={ 
    ...
    phyllotaxy:["2/5"],
    bundleScars:["3"],
    bundleScarsSize:["large"],
    leafScarShape:["crescent"],
    spurs:["yes"],
    fissured:["yes"],
    twig:[""],
    Buds:[""],
...
Populus_trichocarpa={ 
    ...
    bundleScars:["3"],
    leafScarShape:["triangular"],
    budResinous:["yes"],
    budColor:["red,", "orange", "brown"],
    twig:[""],
    Buds:[""],
    leafScars:[""]
};
...
Prunus_emarginata={ 
    ...
    phyllotaxy:["2/5"],
    bundleScars:["3"],
    leafScarShape:["3-lobed", "triangular"],
    spursShoots:["yes"],
    lenticelColor:["pale"],
    lenticelShape:["horizontal"],
    lenticelVisibility:["prominent"],
    twig:[""],
    Buds:[""],
    leafScars:[""]
...
Rubus_leucodermis={ 
    ...
    CommonName:["whitebark raspberry"], 
    arrangement:["alternate"],
    thorns:["true"],
...
function makeCards(){
    ...
    for (let i=0; i < cardAmount; i++){
        ...
        twigCard.setAttribute("onclick", "infoPage(" + i +")");    //add clickable
