    ...
    return (
        <div>
            <div classname="bg-slate-800 border border-slate-400 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-sm relative">
                <h1 className="text-4xl text-whitefont-bold text-center mb-6">Create Account</h1>
                <form action="">
                ...
                <div className="relative my-4">
                    <input type="password" className="block w-72 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-white appearance-none dark:text-white dark:border-blue dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-white focus:border-blue-600 peer" placeholder=""/>
                ...
                <button type="submit" className='w-full mb-4 text-[18px] mt-6 rounded-full bg-white text-[#4389A2] hover:bg-[#4389A2] hover:text-white py-2 transition-colors duration-300" type="submit"'>Create</button>
                <div className='flex justify-between items-center'>
                    <span className="m-4"><Link className="text-blue-500" to='../Register'> Create Account </Link></span>
