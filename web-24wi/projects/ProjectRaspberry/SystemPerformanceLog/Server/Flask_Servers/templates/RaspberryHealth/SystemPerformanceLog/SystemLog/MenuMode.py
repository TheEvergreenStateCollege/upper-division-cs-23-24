...
from SystemLogConfig import csv_log_path
...
def load_data(csv_log_path):
    ...
    try:
        ...
        print(f"The file {csv_log_path} was not found.")
        sys.exit(1)
...
class MenuMain:
    def __init__(self):
        self.user_input = ""
        self.data = load_data(csv_log_path)  # Load data in the constructor
    ...
    def main_menu(self):
        ...
        user_input = (input("""\n
                        ...
                        \n Enter 12 to Print Data as JSON. \
                        \n Enter 0 to Quit. \
    ...
    def run_mode(self):
        ...
        try:
            ...
            if user_choice == 1:
                ...
                print("Printing data as JSON:")
                print(csv_to_json(csv_log_path))
            elif user_choice == 0:
                print("Exiting...")
    ...
    def show_cpu_temp_stats(self):
        ...
        try:
            # Call the script & wait for it to finish loading
