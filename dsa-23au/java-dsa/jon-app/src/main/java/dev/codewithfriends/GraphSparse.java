...
public class GraphSparse<N extends Comparable<N>, E extends Comparable<E>> extends Graph<N, E> {
    ...
    // Edge class representing edges in the graph
    ...
    // Vertex class representing vertices in the graph
    public class Vertex {
        public N label;
        public Map<Vertex, Edge<E>> edges = new HashMap<>();
        // isVisited = false means node is "in the bag"
        //           = true, means we pulled node out of the bag
    ...
    public boolean addEdge(N srcNode, N destNode, E weight) {
        ...
        // Connect the nodes with the new edge
    ...
    // Method to get the minimum weighted edge to an unvisited node from a source node
    @Override
    public Edge<E> getMinEdgeToUnvisitedNode(N sourceNodeLabel) {
        ...
        // Iterate through edges of the source node
    ...
    // Method to print the graph in Mermaid diagram format
    @Override
