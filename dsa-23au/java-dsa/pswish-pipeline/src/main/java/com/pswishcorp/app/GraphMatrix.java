...
public class GraphMatrix<N extends Comparable<N>,E extends Comparable<E>> extends Graph<N,E> {
    ...
    public GraphMatrix(int nodeCount) {
        ...
        matrix = (E[][]) new Object[nodeCount][nodeCount];
    ...
    @Override 
    public void getNodes(N node1, N node2, GraphSparse.Edge<E> edge){
        Vertex nodes1 = verticesMap.get(srcNode);
        Vertex nodes2 = verticesMap.get(destNode);}
